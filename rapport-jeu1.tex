...
\begin{typeag}[Niveau]
 ...
 -       \variable{grille}{[tailleGrilleX][tailleGrilleY]}{représente la taille de la grille en X et Y}\\
 -       \variable{grilleDeDestruction}{booleen [tailleGrilleX][tailleGrilleY]}{représente les cases où un bonbon est présent ou non (en cas de grille non uniforme) \\ex.: 0 = case non jouable \\ 1,2,3,4,5 = couleur de bonbons }
  \end{typeag}		\\
...
\begin{typeag}[Case]
 -       \variable{caseTemporaire}{entier}{variable qui va stocker une case temporaire qui vérifier si il y a alignement ou non}\\
