...
\input{presentation-jeu1.tex}

\section{Jeu 2 : Centipede}
\input{presentation-jeu2.tex}

\section{Conclusion}
\begin{frame}{Conclusion sur les jeux analysés}
	Finalement... % Pourquoi on écrirait une conclu dans un diapo ? Ca doit être fait à l'oral avec à la rigueur qq elmts dans le diap
\end{frame}
